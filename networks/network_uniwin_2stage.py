...
from networks.SASA_Layer import SASA_Layer
...
class BasicLayer_STL(nn.Module):
    ...
    def __init__(
        ...
        super(BasicLayer_STL, self).__init__()
        self.dim = dim
        self.input_resolution = input_resolution
        self.depth = depth
...
class BasicLayer_NATL(nn.Module):
    r""" A basic Swin Transformer layer for one stage.
    ...
    def __init__(
        ...
        super(BasicLayer_NATL, self).__init__()
        self.dim = dim
        self.input_resolution = input_resolution
        self.depth = depth
        self.use_checkpoint = use_checkpoint
...
class RUTB_STL(nn.Module):
    ...
    def __init__(
        ...
        super(RUTB_STL, self).__init__()

        self.dim = dim
        self.input_resolution = input_resolution

        self.residual_group = BasicLayer_STL(
            dim=dim,
            input_resolution=input_resolution,
            depth=depth,
            num_heads=num_heads,
...
class RUTB_NATL(nn.Module):
    ...
    def __init__(
        ...
        super(RUTB_NATL, self).__init__()

        self.dim = dim
        self.input_resolution = input_resolution

        self.residual_group = BasicLayer_NATL(
            dim=dim,
            input_resolution=input_resolution,
            depth=depth,
            num_heads=num_heads,
...
class Uniwin(nn.Module):
    ...
    Args:
        ...
        use_checkpoint (bool): Whether to use checkpointing to save memory. Default: False
        upscale: Upscale factor. 2/3/4/8
        img_range: Image range. 1. or 255.
        resi_connection: The convolutional block before residual connection. '1conv'/'3conv'
        layer_scale: Layer scale factor. Default: 1e-5
    """
